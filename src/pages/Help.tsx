  ...
  >
    ...
    <section className="space-y-3">
      ...
      <p>
        ...
        видны все статусы (открыт, в работе, закрыт); отклик возможен только на открытые.{" "}
        <strong className="text-foreground">Верификация компании не нужна</strong> для публикации тендера — она
        нужна для каталога, витрины услуг/материалов и отклика на чужие тендеры от имени компании. Автор видит блок{" "}
    ...
    <section className="space-y-3">
      ...
      <p>
        ...
        <strong className="text-foreground">«Проверено»</strong>. На услуги, материалы и ролики на витрине действует то же
        правило; <strong className="text-foreground">тендеры авторов</strong> от верификации не зависят.
      </p>
      <p>
